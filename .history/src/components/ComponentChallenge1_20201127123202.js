...
function ComponentChallenge1COPY() {
  ...
  //============ GET REQUEST
  //I DECIDED TO ADDITIONALLY DO A FETCH REQUEST AND VALIDATE THE RESPONSE OBJECT AS PART OF THE VALIDATION CHALLENGE.
  useEffect(() => {
  ...
  const handleTask = () => {
    ...
    //======== IT WILL LOG AN ENTRY IN THE RENDERED TABLE IF ANY DATA TYPE IS CHANGED OR IF ANY FIELD IS LEFT "". YOU CAN MODIFY THE JSON FILES IN src/data/ TO SEE ANY THE ERRORS WILL RENDER WITHIN THE TABLE
