...
function ComponentChallenge1COPY() {
  ...
  const handleTask = () => {
    ...
    //======== IT WILL LOG AN ENTRY IN THE RENDERED TABLE IF ANY DATA TYPE IS CHANGED OR IF ANY FIELD IS LEFT "". YOU CAN MODIFY THE JSON FILES IN src/data/ TO SEE ANY ERRORS RENDERED WITHIN THE TABLE.
